...
class TrackerService : Service() {
    ...
    private lateinit var rideSessionId: String
    ...
    override fun onCreate() {
        ...
        rideSessionId = "ride_${System.currentTimeMillis()}_${UUID.randomUUID().toString().take(8)}"
    }
                ...
                if (response.isSuccessful) {
                    ...
                    if (responseBody != null) {
                        ...
                        if (json.has("riskScore")) {
                             val riskScore = json.getDouble("riskScore")
